...
gatk MarkDuplicates CREATE_INDEX=true INPUT=${bam_file} OUTPUT=${sampleid}/${sampleid}.bam METRICS_FILE=${sampleid}/${sampleid}.dups.mtx VALIDATION_STRINGENCY=STRICT MAX_FILE_HANDLES=1000
...
gatk CollectAlignmentSummaryMetrics  R=$genome_fa I=${sampleid}/${sampleid}out.bam O=${sampleid}/${sampleid}alignment_metrics.txt
